...
class CahootsWeb(CahootsWSGI):

    def __init__(self, config):
        super(CahootsWeb, self).__init__(config)
...
class CahootsAPI(CahootsWSGI):

    def __init__(self, config):
        super(CahootsAPI, self).__init__(config)
...
if __name__ == '__main__':
    wsgi_start('0.0.0.0', 8000, CahootsWeb)
    #wsgi_start('0.0.0.0', 8080, CahootsAPI)